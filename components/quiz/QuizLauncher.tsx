    ...
    <>
      <section id="quiz" className="bg-navy py-16">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <p className="text-peach text-[14px] font-bold tracking-[0.18em] uppercase">Case Check - 60s</p>
          ...
          <button
            ...
            className="mt-7 inline-flex items-center justify-center rounded-full bg-peach border-2 border-peach px-10 py-4 text-[18px] font-bold text-text-dark hover:bg-peach-600 hover:border-peach-600 transition-colors"
          >
            התחלת שאלון
          </button>
        </div>
